...
[0] = LAYOUT(
	...
	KC_LALT,	KC_LGUI,	KC_RALT,										KC_SPC, 							KC_RALT,	MO(1),   	KC_RCTL,							KC_LEFT,	KC_DOWN,    KC_RGHT,	KC_P0,		KC_PDOT),
// layer 1 Mac Fn
[1] = LAYOUT(
...
[2] = LAYOUT(
	...
	KC_LCTL,	KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	KC_ENT,								KC_P4,		KC_P5,		KC_P6,
	TD(TD_LEFT_SHIFT_CAPS),				KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,	TD(TD_RIGHT_SHIFT_CAPS),				KC_UP,		KC_P1,		KC_P2,		KC_P3,		KC_PENT,
	KC_LALT,	KC_LGUI,	KC_RALT,										KC_SPC, 							KC_RALT,	MO(3),   	KC_RCTL,							KC_LEFT,	KC_DOWN,    KC_RGHT,	KC_P0,		KC_PDOT),
// layer 3 win Fn
[3] = LAYOUT(
