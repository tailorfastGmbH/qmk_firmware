...
[0] = LAYOUT_ansi_84(
	...
	KC_LCTL,	KC_LGUI,	KC_RALT,										KC_SPC, 							KC_RALT,	MO(1),   		KC_RCTL,				KC_LEFT,	KC_DOWN,    KC_RGHT),
...
[2] = LAYOUT_ansi_84(
	...
	KC_LALT,			KC_A,   	KC_S,   	KC_D,  		KC_F,   	KC_G,   	KC_H,   	KC_J,   	KC_K,   	KC_L,  		KC_SCLN,	KC_QUOT, 	 						KC_ENT,		KC_HOME,
	TD(TD_LSHIFT_CAPS),	KC_Z,   	KC_X,   	KC_C,  		KC_V,   	KC_B,   	KC_N,   	KC_M,   	KC_COMM,	KC_DOT,		KC_SLSH,		TD(TD_RSHIFT_CAPS),	    KC_UP,	KC_END,
	KC_LCTL,	KC_LGUI,	KC_RALT,										KC_SPC, 							KC_RALT,	MO(3),   	KC_RCTL,				KC_LEFT,	KC_DOWN,    KC_RGHT),
